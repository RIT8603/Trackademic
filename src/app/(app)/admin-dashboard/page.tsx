...
const latecomers = students.filter(s => s.lateCount > 30);
const behavioralFlags = students.filter(s => s.behavioralFlags > 30);
                      ...
                      <TableCell className="text-right font-bold text-destructive">{student.behavioralFlags}</TableCell>
                       <TableCell className="text-right">
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                           <DropdownMenuItem asChild>
                                <a href={`mailto:${student.email}?subject=Behavioral Warning&body=Dear ${student.name},%0D%0A%0D%0AThis is a notification regarding repeated instances of disruptive behavior. You have been flagged ${student.behavioralFlags} times.%0D%0A%0D%0APlease adhere to the code of conduct.%0D%0A%0D%0ARegards,%0D%0AThe Administration`}>Email Student</a>
                            </DropdownMenuItem>
                             <DropdownMenuItem asChild>
                                <a href={`mailto:${student.parent.email}?subject=Student Behavioral Notice: ${student.name}&body=Dear Parent/Guardian,%0D%0A%0D%0AThis is to inform you that ${student.name} has been flagged for disruptive behavior ${student.behavioralFlags} times. %0D%0A%0D%0APlease discuss this with your child.%0D%0A%0D%0ARegards,%0D%0AThe Administration`}>Email Parent</a>
                            </DropdownMenuItem>
                          </DropdownMenuContent>
                        </DropdownMenu>
                      </TableCell>
